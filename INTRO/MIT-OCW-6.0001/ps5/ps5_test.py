...
class ProblemSet5(unittest.TestCase):
    ...
    def test3altBeforeAndAfterTrigger(self):
        ...
        now = now.replace(tzinfo=pytz.timezone("GMT"))
        
        ancient_time = datetime(1987, 10, 15)
        ancient_time = ancient_time.replace(tzinfo=pytz.timezone("GMT"))
        ...
        future_time = future_time.replace(tzinfo=pytz.timezone("GMT"))
